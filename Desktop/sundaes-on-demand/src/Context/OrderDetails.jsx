...
// create custom hook to check wehter we're in a provider
...
export function OrderDetailsProvider(props) {
  ...
  function updateItemCount(itemName, newItemCount, optionType) {
    ...
    //update state with the updated copy
  ...
  function calculateTotal(optionType) {
    ...
    //total values in the array of counts for number of items

    const totalCount = countsArray.reduce((total, value) => total + value, 0);

    //multiply by pricePerItem to get total cost for a particular option type
